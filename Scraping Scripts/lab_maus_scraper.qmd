...
#tournament_id - the id of the specific tournamnet on LabMaus
...
get_tournament_results <- function(tournament_id = 4805, up_to_rank = 50){
  ...
  tibble(
    ...
    first_pokemon = parse_number(first_pokemon),
    second_pokemon = parse_number(second_pokemon),
    third_pokemon = parse_number(third_pokemon),
    fourth_pokemon = parse_number(fourth_pokemon),
    fifth_pokemon = parse_number(fifth_pokemon),
    sixth_pokemon = parse_number(sixth_pokemon)
  )
}
```
